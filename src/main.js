...
(function setupPreloader(){ try{
  ...
  function afterEnd(){ setTimeout(()=>{ try{ if(sheet){ sheet.classList.add('pre-crumple'); setTimeout(()=>{ try{ sheet.classList.remove('pre-crumple'); sheet.classList.add('pre-fold'); }catch(_){ } animateToLogo(); }, 250); } else { animateToLogo(); } }catch(_){ animateToLogo(); } }, 500); }
